...
public class SampleWithSphereTest {
	...
	private static void sampleWithSphere() {
		...
		try {
			Files.writeString(Path.of(RESOURCESDIRECTORYPATH + "sample_with_sphere.ppm"), data.toString());
		} catch (IOException e) {
